...
#C
def insertar_carrera(id_carrera, cve_carrera, nombre_carrera, duracion, requisitos_ad, creditos_gradu):
    conexion_MySQLdb = connectionBD()
    mycursor = conexion_MySQLdb.cursor()
    querySQL = (
        "INSERT INTO universidad.uni_carreras (id_carrrera, Cve_Carrera,Nombre_Carrera,Duracion,Requisitos_ad,Creditos_gradu) VALUES (%s, %s, %s, %s, %s, %s)")
    valores = (id_carrera, cve_carrera, nombre_carrera, duracion, requisitos_ad, creditos_gradu)
...
#U
def actualizar_carrera(id_carrera, cve_carrera, nombre_carrera, duracion, requisitos_ad, creditos_gradu):
    conexion_MySQLdb = connectionBD()
    mycursor = conexion_MySQLdb.cursor()
    querySQL = (
    ...
    valores = (cve_carrera, nombre_carrera, duracion, requisitos_ad, creditos_gradu, id_carrera)
...
def eliminar_carrera(id_carrera):
    ...
    mycursor = conexion_MySQLdb.cursor()
    querySQL = (
        "DELETE FROM universidad.uni_carreras WHERE id_carrrera = %s")
    valores = (id_carrera,)
